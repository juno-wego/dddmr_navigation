...
namespace slamware_ros_sdk {
    ...
    private:
        ...
        // Running estimate of (ros_time_ns - device_time_ns).
        // Used to convert Aurora device timestamps to ROS wall-clock time.
        int64_t  clockOffsetNs_;
        bool     clockOffsetReady_;
    };
